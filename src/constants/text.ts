const text = {
  ...
  NoTikTokInstalled: 'Không tìm thấy phiên bản TikTok nào đã cài đặt.',
  CheckAppError: 'Đã xảy ra lỗi khi kiểm tra ứng dụng.',
  CheckAppIndicator: 'Đang kiểm tra ứng dụng TikTok...',
};
export default text;
